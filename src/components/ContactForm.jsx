...
function ContactForm() {
  ...
  return (
    <div className="bg-white w-full min-h-screen flex flex-col contact-page-wrapper">
      <style>{`
              ...
              >
                ...
                <motion.div variants={itemVariants} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      <a href="mailto:azhizensolutions@azhizen.com" className="hover:underline">
                ...
                <motion.div variants={itemVariants} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      <a href="tel:+918300233988" className="hover:underline">
                        Phone: +91 83002 33988
                      </a>
                    </p>
                  </div>
                </motion.div>
