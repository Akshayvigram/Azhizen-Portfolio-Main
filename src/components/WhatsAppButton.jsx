...
export const WhatsAppButton = ({
  ...
  return (
    <>
      ...
      >
        {/* Exact layered WhatsApp Symbol Design (Overlapping outside left edge) */}
        <div className="relative z-20 flex items-center justify-center w-[44px] h-[44px] shrink-0">
          <svg
            ...
            viewBox="-2 -2 28 28"
          >
            {/* 1. White Outline Base (expanded slightly with stroke) */}
            <path
              fill="#FFF"
              stroke="#FFF"
              strokeWidth="1.8"
            ...
            />
            {/* 2. Inner Green Bubble Fill with transparent phone cutout */}
            <path
              fill="#25D366"
